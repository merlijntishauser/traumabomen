 ...
 *   design (journal entries, turning points, trauma and life events, and
 *   classifications). Structure (persons, relationships, patterns, sibling
 *   groups) stays read-only on the companion and is edited at the desk.
 */
enum class EntityType(
    ...
    CLASSIFICATIONS("classifications", "classifications", personLinked = true, companionWritable = true),
